...
export default function App() {
  ...
  const [windows, setWindows] = useState<{ [key in AppType]?: WindowItem }>({
    welcome: {
      id: "welcome",
      title: "Welcome to gemstoneOS 97",
      isOpen: true,
      isMinimized: false,
      isMaximized: false,
      x: 60,
  ...
  // Bios click alerts
  const playBiosClick = useCallback(() => {
      ...
      <div className="fixed inset-0 bg-black flex flex-col items-center justify-center text-[#ff3a3a] font-mono select-none p-4">
        <div className="text-center space-y-4 max-w-[400px]">
          ...
          <p className="text-xs text-gray-400">
            gemstoneOS 97 has successfully unmounted core processor threads and parked hard disks.
          </p>
          <button
            onClick={() => {
          ...
          <div className="flex-1 p-5 text-black font-sans bg-[#c0c0c0] flex flex-col justify-between h-full select-text" id="app-welcome">
            <div className="space-y-3">
              <div className="flex items-center gap-3 border-b-2 border-double border-blue-900 pb-2">
                ...
                <div>
                  <h2 className="text-base font-extrabold text-[#000080]">WELCOME TO gemstoneOS 97!</h2>
                  <p className="text-[10.5px] text-gray-500 font-mono">Build 16-Bit desktop matrix release (Codename Fjord)</p>
                </div>
              </div>

              <div className="text-xs space-y-2 leading-relaxed">
                <p>
                  Golly! Welcome to gemstoneOS 97, also known under the secret development <strong>Codename Fjord</strong>!
                  This is the most dazzling and beautiful mineral computing simulation.
            ...
            <div className="space-y-4">
              <div className="flex items-center gap-2 border-b border-[#808080] pb-2">
                ...
                <div>
                  ...
                  <p className="text-[10px] text-gray-500">gemstoneOS Professional Edition 1997 (Codename Fjord)</p>
                </div>
              </div>
