    ...
    const welcomeMsgs: ChatMessage[] = [
      {
        id: "wel-1",
        role: "assistant",
        text: "Golly! Welcome to gemstoneOS 97 (Codename Fjord)! I am Gemmy, your virtual interactive geode assistant. " +
              ...
              "Ask me anything about old technology, our secret Codename Fjord release, or request commands!",
