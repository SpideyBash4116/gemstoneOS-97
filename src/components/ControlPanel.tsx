...
export default function ControlPanel({
  ...
  const [activeTab, setActiveTab] = useState<"wallpaper" | "sounds" | "screensaver">("wallpaper");

  const wallpapers: { preset: WallpaperPreset; name: string; desc: string; color: string }[] = [
    { preset: "teal", name: "Modern Teal '97", desc: "Our beautiful flagship gemstoneOS brand palette.", color: "bg-[#0d5c5c]" },
